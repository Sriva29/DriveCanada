...
<div class="container">
        ...
        <div class="main">
            ...
            <form action=".php" method="POST">
                ...
                <label class="fo1">Creat a new account</label>
                <input class="fo2" type="email" placeholder="email" required/>
        
            
                <input class="fo2" name="userName" type="text" placeholder="User Name" required>
        
                <input class="fo2" name="passWord" type="text" placeholder="strong password" required>
        
                <button id="buc" type="button" onclick= "href='Home.html'">Create Account</button>
